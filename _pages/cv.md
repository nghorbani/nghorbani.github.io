...
* 10.2025 – Present\
  ...
  Cubert Hyperspectral, Ulm, Germany (On-site)\
  At Cubert GmbH, I focus on AI frameworks, agentic tools, and scalable data-processing systems for hyperspectral imaging and industrial computer vision. My work bridges advanced sensor data with modern AI workflows, including modular processing pipelines, machine learning integration, natural-language analysis of visual and spectral data, and production-oriented systems for real-world industrial applications.

* 09.2024 – 10.2025\
  Head of Artificial Intelligence\
  Sporttotal Technology GmbH, Berlin, Germany (Remote)\
